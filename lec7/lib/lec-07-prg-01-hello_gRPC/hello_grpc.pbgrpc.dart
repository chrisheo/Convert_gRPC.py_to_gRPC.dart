...
class MyServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.MyNumber> myFunction($0.MyNumber request,
      {$grpc.CallOptions? options}) {
...
abstract class MyServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.MyNumber> myFunction_Pre(
      $grpc.ServiceCall call, $async.Future<$0.MyNumber> request) async {
    return myFunction(call, await request);
  }

  $async.Future<$0.MyNumber> myFunction(
      $grpc.ServiceCall call, $0.MyNumber request);
}
